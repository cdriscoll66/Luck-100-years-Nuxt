    ...
    <div class="story">
      <div class="title-block">
        <div class="title-block__inner">
            ...
            <img src="/images/yourstories/MichelleTrudeau.png" alt="Michelle Trudeau profile image">
            </div>
          <div class="title-block__text">
            ...
            <p class="tagline">7 Years of Service</p>
          </div>
        </div>
      </div>
      
 <AudioPlayer audio="/audio/Michelle Trudeau (music).mp3" />
    ...
    <div class="pagination-links">
      ...
      <NuxtLink class="next" to="/your-stories/goochland-fire">
