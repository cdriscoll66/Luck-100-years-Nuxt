    ...
    <div class="story">
      <div class="title-block">
        <div class="title-block__inner">
            ...
            <img src="/images/yourstories/conradFeggins.png" alt="Conrad Feggins profile image">
            </div>
          <div class="title-block__text">
            <div class="eyebrow">
              <div class="listen">Listen</div>
            </div>
            <h1>Conrad Feggins</h1>
            <p class="subtitle">Retiree</p>
            <p class="tagline">21 Years of Service</p>
          </div>
        </div>
      </div>
      
 <AudioPlayer audio="/audio/Conrad Feggins (music).mp3" />
      <div class="story__content">
        ...
        <p>
          ...
          ridiculus sed magna. Ut enim ad minim veniam, quis nostrud
          exercitation. Fictum, deserunt mollit anim laborum astutumque! Ab illo
          tempore, ab est sed immemorabili.
        </p>
        <p>
    ...
    <div class="pagination-links">
      ...
      <NuxtLink class="next" to="/your-stories/tom-williams">
