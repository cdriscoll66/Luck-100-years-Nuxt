...
<template>
    ...
    <div class="story">
      <div class="title-block">
        <div class="title-block__inner">
            ...
            <img src="/images/yourstories/aubryWitt.png" alt="aubrey witt profile image">
            </div>
          <div class="title-block__text">
            ...
            <p class="tagline">34 Years of Service</p>
          </div>
        </div>
      </div>
 ...
 <AudioPlayer audio="/audio/Aubrey Witt (music).mp3" />
    ...
    <div class="pagination-links">
      ...
      <NuxtLink class="next" to="/your-stories/bill-scharr">
